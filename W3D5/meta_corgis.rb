...
class MetaCorgiSnacks
  ...
  #   fetch_snack_info_method = "get_#{name}_info"
  #   fetch_snack_tastiness_method = "get_#{name}_tastiness"

  #   info = @snack_box.send(fetch_snack_info_method, @box_id)
  #   tastiness = @snack_box.send(fetch_snack_tastiness_method, @box_id)
